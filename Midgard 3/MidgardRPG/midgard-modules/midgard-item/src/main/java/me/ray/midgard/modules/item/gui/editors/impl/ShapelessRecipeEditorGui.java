...
public class ShapelessRecipeEditorGui extends BaseGui {
    ...
    public ShapelessRecipeEditorGui(Player player, ItemModule module, MidgardItem item, BaseGui parent, String recipeId) {
    ...
    public void initializeItems() {
        ...
        // Slot 11: Switch Output Mode (Shapeless is always shapeless, but keep button for consistency or disable it)
        // For shapeless editor, maybe force shapeless mode display
        List<String> modeLore = MidgardCore.getLanguageManager().getStringList("item.gui.crafting_gui.editor.common.output_mode.lore");
        modeLore.replaceAll(l -> l.replace("%s", MidgardCore.getLanguageManager().getRawMessage("item.gui.crafting_gui.editor.common.output_mode.shapeless")));
    ...
    public void onClick(InventoryClickEvent event) {
        ...
        if (slot == 11) {
            // Shapeless is always shapeless, no action
            return;
        }
