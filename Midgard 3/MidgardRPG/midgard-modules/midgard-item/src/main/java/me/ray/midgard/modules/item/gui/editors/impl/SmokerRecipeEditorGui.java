...
public class SmokerRecipeEditorGui extends BaseGui {
    ...
    public SmokerRecipeEditorGui(Player player, ItemModule module, MidgardItem item, BaseGui parent, String recipeId) {
        super(player, 6, "key:item.gui.crafting_gui.editor.titles.smoker");
        this.module = module;
        this.item = item;
        this.parent = parent;
    ...
    public void initializeItems() {
        ...
        String ingredient = ingredients.get(0); // Slot 0 for smoker input
        ItemStack inputItem;
        if (ingredient != null) {
