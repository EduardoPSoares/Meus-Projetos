...
public class FurnaceRecipeEditorGui extends BaseGui {
    ...
    public FurnaceRecipeEditorGui(Player player, ItemModule module, MidgardItem item, BaseGui parent, String recipeId) {
        super(player, 6, "key:item.gui.crafting_gui.editor.titles.furnace");
        this.module = module;
        this.item = item;
        this.parent = parent;
    ...
    public void initializeItems() {
        ...
        String ingredient = ingredients.get(0); // Slot 0 for furnace input
        ItemStack inputItem;
        if (ingredient != null) {
