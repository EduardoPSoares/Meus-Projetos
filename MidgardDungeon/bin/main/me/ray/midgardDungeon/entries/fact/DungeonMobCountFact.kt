...
@Entry("dungeon_mob_count_fact", "Retorna o número de mobs rastreados vivos na dungeon", Colors.RED, "mdi:skull")
class DungeonMobCountFact(
    ...
    override fun readSinglePlayer(player: Player): FactData {
        val instance = DungeonManager.getInstanceByPlayer(player.uniqueId)
            ?: return FactData(0)
        return FactData(instance.getAliveTrackedEntities().size)
    }
}
