...
@Entry("dungeon_elapsed_fact", "Retorna os segundos decorridos desde o início da dungeon", Colors.BLUE, "mdi:clock-outline")
class DungeonElapsedFact(
    ...
    override fun readSinglePlayer(player: Player): FactData {
        val instance = DungeonManager.getInstanceByPlayer(player.uniqueId)
            ?: return FactData(0)
        return FactData(instance.getElapsedSeconds().toInt())
    }
}
