...
public class PermissionManager {
    ...
    public static Permission RANGE_ADMIN_PERMISSION = new Permission(Voicechat.MODID + ".range.admin", PermissionDefault.OP);
    public static Permission GLOBAL_ADMIN_PERMISSION = new Permission(Voicechat.MODID + ".global.admin", PermissionDefault.OP);
